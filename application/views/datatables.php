...
<body>
  <div class="container">
	...
	<!-- Modal Add Produk-->
	  <form id="add-row-form" action="<?php echo site_url('dtable/simpan')?>" method="post">
	 ...
	 <!-- Modal Update Produk-->
 	  <form id="add-row-form" action="<?php echo site_url('dtable/update')?>" method="post">
	 ...
	 <!-- Modal Hapus Produk-->
 	  <form id="add-row-form" action="<?php echo site_url('dtable/delete')?>" method="post">
	...
	$(document).ready(function(){
      ...
      var table = $("#mytable").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo site_url('dtable/get_produk_json') ?>", "type": "POST"},
                	columns: [
												{"data": "barang_kode"},
												{"data": "barang_nama"},
